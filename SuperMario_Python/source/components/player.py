...
class Player(pg.sprite.Sprite):
    ...
    def restart(self):
        '''reiniciar após a morte do jogador ou ir para o próximo nível'''
        if self.dead:
            self.dead = False
            self.big = False
            self.fire = False
    ...
    def jumping(self, keys, fire_group):
        """ valor y_vel: positivo está para baixo, negativo está para cima """
        self.check_to_allow_fireball(keys)
    ...
    def changing_to_big(self):
        ...
        # valor do tamanho 0:pequeno, 1:médio, 2:grande
    ...
    def changing_to_small(self):
        ...
        # valor do tamanho 0:grande, 1:médio, 2:pequeno
    ...
    def changing_to_fire(self):
        ...
        # valor do tamanho 0:fogo, 1:verde grande, 2:vermelho grande, 3:preto grande
