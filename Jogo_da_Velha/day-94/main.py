...
screen.title("Invasão do espaço!!")
screen.tracer(0)
...
# Inicializar o jogo - a e d andar para os lados // espaço atira
screen.update()
screen.listen()
...
while game_is_on == True:
    ...
    if scoreboard.lives <= 0:
        scoreboard.GameOver(Reason="Vidas")
        game_is_on = False
    ...
    if fleet.DetectLowerBoundary() == True:
        scoreboard.GameOver(Reason="Invasão")
        game_is_on = False
